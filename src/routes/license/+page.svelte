...
<div class="bg-base-200">
	<Navbar />
	<div class="container mx-auto flex w-full max-w-7xl justify-center py-8">
		<div class="text-center">
			<h1 class="text-4xl font-bold">The Unlicense</h1>
		</div>
	</div>
	<div class="container mx-auto flex w-full max-w-2xl justify-center">
		<div class="py-4 text-pretty">
			<p class="max-w-4xl text-xl">
				...
				means. In jurisdictions that recognize copyright laws, the author or authors of this
				...
				<a class="underline" href="https://unlicense.org">https://unlicense.org</a>
			</p>
		</div>
	</div>
	<Footer />
